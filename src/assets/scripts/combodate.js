    ...
    Combodate.prototype = {
        ...
        */
        initCombos: function() {
            ...
            for (var k in this$1.map) {
                var $c = this$1.$widget.find('.'+k);
                // set properties like this.$day, this.$month etc.
                this$1['$'+k] = $c.length ? $c : null;
                // fill with items
                this$1.fillCombo(k);
            }
        },
        ...
        */
        fillDay: function() {
            ...
            for (i = 1; i <= daysCount; i++) {
                name = twoDigit ? this$1.leadZero(i) : i;
                items.push([i, name]);
            }
            return items;
        },
        ...
        */
        fillYear: function() {
            ...
            for(i=this.options.maxYear; i>=this.options.minYear; i--) {
                ...
                items[this$1.options.yearDescending ? 'push' : 'unshift']([i, name]);
            }
...
/******/ });
//# sourceMappingURL=combodate.js.map